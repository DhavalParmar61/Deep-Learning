...
from processing.dataprocessing import get_data, GL_to_int
...
def run_training()-> None:
    ...
    # Classifier
    model = LogisticRegression(max_iter = config.model_config.max_iterations)
    model.fit(X_train, Y_train)
    pickle.dump(model,open(config.model_config.model_path,'wb'))
